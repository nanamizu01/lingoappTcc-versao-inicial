...
public class AlterarDadosEstudanteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alterardados_estudante);
    ...
    private void text_excluirContaActivity() {
        AlertDialog.Builder confirmar_exclusao_conta = new AlertDialog.Builder(AlterarDadosEstudanteActivity.this);
        ...
        confirmar_exclusao_conta.setPositiveButton("Excluir", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                AlertDialog.Builder conta_excluida = new AlertDialog.Builder(AlterarDadosEstudanteActivity.this);
